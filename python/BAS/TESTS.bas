...
520 PRINT "Testing";
530 PRINT " no CR printing"
540 PRINT "Testing input"
550 INPUT "Type Something: "; T$
560 PRINT "You Typed: "; T$
570 PRINT "*** Finished ***"
580 STOP
600 REM A SUBROUTINE TEST
610 PRINT "Executing the subroutine"
620 RETURN
700 REM AN OUTER SUBROUTINE
710 GOSUB 800
720 PRINT "This should be printed second"
730 RETURN
800 REM A NESTED SUBROUTINE
810 PRINT "This should be printed first"
820 RETURN
